    ...
    return (
        <div className="app-container">
            <main className="main">
                ...
                <p className="text-start">We strive to connect people across the Pacific Northwest 
                ...
                <p className="text-start">First, find an event that interests you! PNW Connects offers
                    ...
                    third-party vendors where you can securely buy your ticket.</p>
                <p className="text-start">After purchasing your ticket, RSVP for the event on our 
                    ...
                    an email with details about a designated check-in location and your mission instructions.</p>

                <h1 className="text-dark mb-4 text-start fs-4">What is a Mission?</h1>
                <p className="text-start">A mission is a mini-adventure designed to help you break
                    ...
                    PNW Connects.</p>
                <p className="text-start">Missions are designed to ease the process of meeting new
